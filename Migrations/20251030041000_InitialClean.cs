    ...
    public partial class InitialClean : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MemberExperienceLevels", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TasksPriority", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ManagedProjectsId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ManagerProfileId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_ManagerProfiles_ManagerProfileId",
                        column: x => x.ManagerProfileId,
                        principalTable: "ManagerProfiles",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AspNetUsers_MemberProfiles_MemberProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InvitationCodes_Projects_ProjectId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignedToMemberId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tasks_AspNetUsers_AssignedToMemberId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Tasks_MemberProfiles_MemberProfileId",
                        column: x => x.MemberProfileId,
                        principalTable: "MemberProfiles",
                        principalColumn: "Id");
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Tasks_TasksPriority_PriorityId",
                        column: x => x.PriorityId,
                        principalTable: "TasksPriority",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Tasks_TasksStatus_StatusId",
                        column: x => x.StatusId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_ManagerProfileId",
                table: "AspNetUsers",
                column: "ManagerProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_MemberProfileId",
                table: "AspNetUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvitationCodes_ProjectId",
